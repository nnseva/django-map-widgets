(function ($) {
    DjangoMapLineStringWidgetBase = $.Class.extend({
        ...
        init: function (options) {
            ...
            // if the field in a collapsed Django admin fieldset, re-init when expanded
        ...
        resetMap: function () {
            if (!$.isEmptyObject(this.djangoGeoJSONValue)) {
                ...
                $(document).trigger(this.lineDeleteTriggerNameSpace,
