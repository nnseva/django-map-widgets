...
def minify_js_files():
    ...
    _JS_MAPPING = {
        ...
        "MapboxLineStringFieldWidget": {
            "dev_js_paths": mw_settings.Mapbox.LineStringField.interactive.media.js.dev,
            "minified_js_path": mw_settings.Mapbox.LineStringField.interactive.media.js.minified,
        },
